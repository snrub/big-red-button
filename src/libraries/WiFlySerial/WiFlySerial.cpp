...
prog_char s_WIFLYDEVICE_SET_EXTERNAL_ANT[] PROGMEM =" set wlan e ";
...
#define STI_WIFLYDEVICE_SET_EXTERNAL_ANT  58
...
{ 
  ...
  s_WIFLYDEVICE_SAVE,
  s_WIFLYDEVICE_SET_EXTERNAL_ANT
};
...
// SetExternalAnt
// Sets whether to use external antenna 
// Parameters:
// iUseExt      null-terminated character string of the channel e.g. '6'
boolean WiFlySerial::setUseExternalAnt( int iUseExt) {
  
  char bufMode[10];
  
  itoa( iUseExt, bufMode, 10);
  return issueSetting( STI_WIFLYDEVICE_SET_EXTERNAL_ANT, bufMode );
}
